...
[Serializable]
public class SpriteAnimation//自定义的Sprite Animation基类，用来控制各类角色的自定义动画。
{
    ...
    int currentFrames;
    float timer;
    public SpriteAnimation(List<Sprite> frames, SpriteRenderer spriteRenderer, float frameRate = 0.16f)//初始化当前的自定义Animator
    {
